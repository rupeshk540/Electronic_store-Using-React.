...
import image from "../assets/default_profilepic.jpg";
                ...
                <Card.Body>
                    <Row className="align-items-center">
                        <Col md={2} className="text-center">
                            <img src={(category.coverImage ? (category.coverImage.startsWith("http") ? category.coverImage:image): image)} className="rounded-circle" style={imageStyle}/>
                        </Col>
                        ...
                        <Col md={2}>
                            <Container className="d-grid">
                                ...
                                <Button className="mt-1" size="sm" variant="warning" onClick={(event)=>updateCat(category)}>Update</Button>
                            </Container>
                        </Col>
